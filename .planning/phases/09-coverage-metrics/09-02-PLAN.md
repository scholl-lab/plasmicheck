...
<task type="auto">
  ...
  <action>
    ...
    **IMPORTANT:** Also update compare_alignments.py to write a `CoverageFallback\t{True|False}` row to summary.tsv (after all coverage metric rows). This is a small addition to Plan 01's work in compare_alignments.py.
