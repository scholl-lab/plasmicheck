...
# Plotting Functions
def plot_boxplot(boxplot_data: pd.DataFrame, output_dir: str) -> tuple[str, str]:
    ...
    boxplot_filename_png: str = os.path.join(plots_dir, "boxplot_contamination_ratios.png")
...
def plot_heatmap(
    ...
    heatmap_filename_png: str = os.path.join(plots_dir, plot_config["output_filename"])
